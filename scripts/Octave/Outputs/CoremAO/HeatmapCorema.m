...
DIVGra(i,3) = sum(DIVS);#diversity :: 3rd column
DIVGra(i,1) = str2double(middleStringM);#migration :: 1st column
DIVGra(i,2) = str2double(middleStringG);#gamma :: 2nd column
#pause
end
#======================================================

#Consumers========================================================
files = dir('CoremaC*.csv');
num_files = length(files);
#results = cell(length(files), 1);
for i = 1:num_files
...
DIVGca(i,3) = sum(DIVS);#diversity :: 3rd column
DIVGca(i,1) = str2double(middleStringM);#migration :: 1st column
DIVGca(i,2) = str2double(middleStringG);#gamma :: 2nd column
#pause
end
#=====================================================================
