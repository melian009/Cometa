...
%pause
 ...
 pause
                          ...
                          BirthWBADR = (WB+WA+WD)/max(WB+WA+WD);%Second output
                          %BirthWBADR = (WB+WA+WD)/3;%First outputs         
...
%___________________________________
			 ...
			 %Fitness, W Abiotic===================================
                 ...
                 %================================================================================
                          ...
                          BirthWBADC = (WB+WA+WD)/max(WB+WA+WD);%Second output
                          %BirthWBADC = (WB+WA+WD)/3;%First output         
