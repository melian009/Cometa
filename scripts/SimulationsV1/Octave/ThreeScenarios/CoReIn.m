...
for r = 1:MaxRep;%tic -- #replicates  
         ...
         %-----OUTPUTS--------------------------------------------------------------
         fnamR = sprintf('CoreinR_m%0.4f_gamma%04d',m,gamma);
         fnamC = sprintf('CoreinC_m%0.4f_gamma%04d',m,gamma);
         migration = sprintf('migration_m%0.4f',m);
         coevgamma = sprintf('gamma_gamma%04d',gamma);
         fnamDistanceMatrix = sprintf('CoreinDM_m%0.4f_gamma%04d',m,gamma);
         %==========================================================================
...
%pause
		 ...
		 %-----------W each individual for births                      
                 ...
                 %=========================================================================================
                          ...
                          %Trait integration scenario
                          BirthWBADR = (WB+WA+WD)/3;
                          %BirthWBADR = (WB+WA+WD)/max(WB+WA+WD);%CoReIn.m (cov matrix)
...
%___________________________________
                 ...
                 %================================================================================
                          ...
                          %Trait integration scenario
                          BirthWBADC = (WB+WA+WD)/3;
                          %BirthWBADC = (WB+WA+WD)/max(WB+WA+WD);%CoReIn.m (cov matrix)
