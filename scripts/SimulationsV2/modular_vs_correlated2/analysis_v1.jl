...
plot!(df1[:, "selection_coeff"], df1[:, "diversity_index"], label="Correlated",seriestype = :scatter, color=["red"],xlabel="Selection", ylabel="Diversity", title="")
...
plot(df2[:, "selection_coeff"], df2[:, "diversity_index"], label="Modular",seriestype = :scatter, color=["blue"], xlabel="Selection", ylabel="Diversity", title="")
...
#  x = {:selection_coeff, type = :quantitative, title = "Selection"},
#  y = {:diversity_index, type = :quantitative, title = "Diversity"},
  #y = {:abiotic_coeff, type = :quantitative, title = "Abiotic coefficient"},
  #color={:diversity_index, scale={scheme="viridis"}},
  #width=500,
  #height=500
...
#  VegaLite.save(joinpath("plots", "diversity_$(group[1,:selection_coeff]).png"), p)
#end
